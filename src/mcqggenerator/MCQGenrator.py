...
from src.mcqggenerator.utils import read_file,get_table_data
from src.mcqggenerator.logger import logging
...
response returned my be just json string, dont not any extra symbol it
Quiz_MCQs:
{quiz}
